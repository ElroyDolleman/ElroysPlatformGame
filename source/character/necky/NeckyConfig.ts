export class NeckyConfig
{
	private constructor() {}

	public static readonly RUN_SPEED: number = 82;
	public static readonly RUN_ACCEL: number = 5;
	public static readonly FULL_SPEED_FRAMERATE: number = 12;
